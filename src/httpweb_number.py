        ...
        try:
            ...
            if _user_number:
                ...
                # Ввод данных о номере
                    ...
                    print(f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["RED"]}9{COLOR_CODE["CYAN"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://google.ru/search?q={COLOR_CODE["PINK"]}{_user_number}{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск по Google')

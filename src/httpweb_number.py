        ...
        try:
            ...
            if _user_number:
                ...
                # Ввод данных о номере
                    ...
                    print(f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["RED"]}9{COLOR_CODE["CYAN"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://yandex.ru/yandsearch?text={COLOR_CODE["PINK"]}{_user_number}{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск по Yandex')
                    print(f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["RED"]}10{COLOR_CODE["CYAN"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://google.ru/search?q={COLOR_CODE["PINK"]}{_user_number}{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск по Google')
                    print(f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["RED"]}11{COLOR_CODE["CYAN"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}tel:{COLOR_CODE["PINK"]}{_user_number}{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Звонок на номер с телефона')

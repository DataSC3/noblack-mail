        ...
        try:
            ...
            if _user_number:
                ...
                # Ввод данных о номере
                    ...
                    print(f'{COLOR_CODE["CYAN"]}{COLOR_CODE["BOLD"]}[{COLOR_CODE["RED"]}4{COLOR_CDE["CYAN"]}] {COLOR_CODE["URL_L"]}{COLOR_CODE["UNDERLINE"]}https://ok.ru/dk?st.cmd=anonymRecoveryStartPhoneLink{COLOR_CODE["RESET"]}{COLOR_CODE["DARK"]} - Поиск аккаунта OK')
